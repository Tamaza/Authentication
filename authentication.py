...
def cameron():
    ...
    take = selfie.pic()
    try:
        analyze = face_rec.analize()
        if(analyze == 3):
            login_success()
    except IndexError:
        Label(screen0, text="Invalid User", fg="green", font=("Calibri", 11)).pack()
...
def login():
    ...
    Button(screen2, text="Face", width=10, height=1, command=cameron).pack()
